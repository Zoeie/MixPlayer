...
import com.zoe.android.exoplayer2.Player.RepeatMode;
...
/* package */ final class MediaPeriodQueue {
  ...
  /**
   * Sets the {@link Timeline}. Call {@link #updateQueuedPeriods(MediaSource.MediaPeriodId, long)} to update the
   ...
   * @return The identifier for the first media period to play, taking into account unplayed ads.
   */
  private MediaSource.MediaPeriodId resolveMediaPeriodIdForAds(
  ...
  private MediaPeriodInfo getMediaPeriodInfo(
          MediaSource.MediaPeriodId id, long contentPositionUs, long startPositionUs) {

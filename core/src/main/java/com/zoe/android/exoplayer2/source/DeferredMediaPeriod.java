 ...
 * MediaSource#createPeriod(MediaSource.MediaPeriodId, Allocator)} method until {@link
 * #createPeriod(MediaSource.MediaPeriodId)} has been called. This is useful if you need to return a media
...
public final class DeferredMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
  ...
  /** The {@link MediaSource.MediaPeriodId} used to create the deferred media period. */
  ...
  /**
   * Calls {@link MediaSource#createPeriod(MediaSource.MediaPeriodId, Allocator)} on the wrapped source then

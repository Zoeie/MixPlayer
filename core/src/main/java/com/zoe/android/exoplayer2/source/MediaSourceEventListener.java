...
public interface MediaSourceEventListener {
   ...
   * @param mediaPeriodId The {@link MediaSource.MediaPeriodId} of the created media period.
   */
   ...
   *
   * @param windowIndex The window index in the timeline this media period belongs to.
   * @param mediaPeriodId The {@link MediaSource.MediaPeriodId} of the released media period.
   */
   ...
   *
   * @param windowIndex The window index in the timeline this media period belongs to.
   * @param mediaPeriodId The {@link MediaSource.MediaPeriodId} of the media period being read from.
   */
  ...
  final class EventDispatcher {
    ...
    /** Dispatches {@link #onMediaPeriodCreated(int, MediaSource.MediaPeriodId)}. */
    ...
    /** Dispatches {@link #onMediaPeriodReleased(int, MediaSource.MediaPeriodId)}. */
    ...
    /** Dispatches {@link #onReadingStarted(int, MediaSource.MediaPeriodId)}. */

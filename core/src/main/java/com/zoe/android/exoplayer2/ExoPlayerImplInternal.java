...
import com.zoe.android.exoplayer2.Player.DiscontinuityReason;
...
import com.zoe.android.exoplayer2.trackselection.TrackSelectorResult;
...
import com.zoe.android.exoplayer2.util.HandlerWrapper;
...
/* package */ final class ExoPlayerImplInternal
  ...
  private long seekToPeriodPosition(MediaSource.MediaPeriodId periodId, long periodPositionUs)
      throws ExoPlaybackException {
  ...
  private long seekToPeriodPosition(
          MediaSource.MediaPeriodId periodId, long periodPositionUs, boolean forceDisableRenderers)
      throws ExoPlaybackException {
    stopRenderers();
    rebuffering = false;
    setState(Player.STATE_BUFFERING);
  ...
  private void handleSourceInfoRefreshed(MediaSourceRefreshInfo sourceRefreshInfo)
    ...
    if (pendingPrepareCount > 0) {
      ...
      if (pendingInitialSeekPosition != null) {
        ...
        try {
          ...
          MediaSource.MediaPeriodId firstMediaPeriodId =
              playbackInfo.getDummyFirstMediaPeriodId(shuffleModeEnabled, window);
          playbackInfo =
        ...
        if (periodPosition == null) {
          ...
          MediaSource.MediaPeriodId periodId = queue.resolveMediaPeriodIdForAds(periodUid, positionUs);
          playbackInfo =
              playbackInfo.resetToNewPosition(
        ...
        if (timeline.isEmpty()) {
          ...
          MediaSource.MediaPeriodId periodId = queue.resolveMediaPeriodIdForAds(periodUid, startPositionUs);
          playbackInfo =
              playbackInfo.resetToNewPosition(
                  periodId,
    ...
    if (periodIndex == C.INDEX_UNSET) {
      ...
      MediaSource.MediaPeriodId periodId = queue.resolveMediaPeriodIdForAds(newPeriodUid, contentPositionUs);
    ...
    MediaSource.MediaPeriodId playingPeriodId = playbackInfo.periodId;

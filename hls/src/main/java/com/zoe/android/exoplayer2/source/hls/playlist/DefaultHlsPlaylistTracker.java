 ...
 */
package com.zoe.android.exoplayer2.source.hls.playlist;
...
import com.zoe.android.exoplayer2.source.hls.HlsDataSourceFactory;
...
public final class DefaultHlsPlaylistTracker
  ...
  private @Nullable
  HlsMasterPlaylist.HlsUrl primaryHlsUrl;
  ...
  private boolean notifyPlaylistError(HlsMasterPlaylist.HlsUrl playlistUrl, long blacklistDurationMs) {
    int listenersSize = listeners.size();
